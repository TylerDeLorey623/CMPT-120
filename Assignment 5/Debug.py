def main():
    ...
    char = input("Enter an asterisk or ampersand ")
    if char == "*" or char == "&":
        print("Good job. You entered a", char)
    else:
    ...
    maristString = input("Enter a string that has the substring 'marist' ")
    if "marist" in maristString:
        print("Good job!")
    else:
        print("Wrong.")
